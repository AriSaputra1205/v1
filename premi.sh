...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/AriSaputra1205/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/AriSaputra1205/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/AriSaputra1205/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/AriSaputra1205/v1/main/"
start=$(date +%s)
secs_to_human() {
...
TIMES="10"
CHATID="8109548390"
KEY="7667380386:AAGGM8-64145s1jCHQiwW8U0bOxdVgjVafQ"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/AriSaputra1205/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/AriSaputra1205/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/tenkurivpnstore"},{"text":"Contack","url":"wa.me/6285279684327"}]]}'
...
wget "http://raw.githubusercontent.com/AriSaputra1205/v1/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m          ----[ ARI SUMSEL TUNNELING PROJECT ]----                \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e "\e[95;1m  Telegram : t.me/tenkurivpnstore \e[0m"
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
